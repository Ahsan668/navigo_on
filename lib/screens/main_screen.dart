...
import 'package:navigo_on/screens/drawer_screen.dart';
import 'package:navigo_on/screens/precise_pickup_screen.dart';
import 'package:navigo_on/screens/rate_driver_screen.dart';
import 'package:navigo_on/screens/search_place_screen.dart';
...
import '../Assistants/grofire_assistant.dart';
...
class MainScreen extends StatefulWidget {
  ...
  @override
  State<MainScreen> createState() => _MainScreennState();
}
...
class _MainScreennState extends State<MainScreen> {
      ...
      if (map != null) {
        ...
        switch (callBack) {
          ...
          case Geofire.onKeyEntered:
            ...
            activeNearByAvailableDrivers.locationLattitude = map["latitude"];
    ...
    setState(() {
      ...
      for (ActiveNearByAvailableDrivers eachDriver
        ...
        LatLng eachDriverActivePosition = LatLng(
            eachDriver.locationLattitude!, eachDriver.locationLongitude!);
  ...
  Future<void> drawPolyLineFromOriginToDestination(bool darkTheme) async {
    ...
    var originLatLng = LatLng(
        originPosition!.locationLatitiude!, originPosition.locationLongitiude!);
    var destinationLatLng = LatLng(destinationPosition!.locationLatitiude!,
        destinationPosition.locationLongitiude!);
  ...
  saveRideRequestInformation(String selectedVehicleType) {
    ...
    Map originLocationMap = {
      //"key: value"
      "latitude": originLocation!.locationLatitiude.toString(),
      "longitude": originLocation.locationLongitiude.toString(),
    };

    Map destinationLocationMap = {
      //"key: value"
      "latitude": destinationLocation!.locationLatitiude.toString(),
      "longitude": destinationLocation.locationLongitiude.toString(),
    };
  ...
  updateReachingTimeToUserDropOffLocation(driverCurrentPositionLatLng) async {
    if (requestPositionInfo == true) {
      ...
      LatLng userDestinationPosition = LatLng(
        dropOffLocation!.locationLatitiude!,
        dropOffLocation.locationLongitiude!,
      );
